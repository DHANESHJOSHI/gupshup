...
module.exports = {
    ...
    videoAI: {
        ...
        apiKey: '',
        systemLimit:
            'You are a streaming avatar from Gupshup, an industry-leading product that specialize in videos communications.',
    },
    email: {
        /*
    ...
    mattermost: {
        ...
        Mattermost: https://mattermost.com
            ...
            2. Click on Add Slash Command and configure the following settings:
                ...
                - Autocomplete Description: Provide a brief description (e.g., `Get GupShup meeting room`).
    ...
    ui: {
        ...
        */
        brand: {
            app: {
                name: 'GupShup',
                title: 'GupShup<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
                description:
                    'Start your next video call with a single click. No download, plug-in, or login is required. Just get straight to talking, messaging, and sharing your screen.',
            },
            site: {
                title: 'GupShup, Free Video Calls, Messaging and Screen Sharing',
                icon: '../images/logo.svg',
                appleTouchIcon: '../images/logo.svg',
            },
            meta: {
                description:
                    'GupShup powered by WebRTC and mediasoup, Real-time Simple Secure Fast video calls, messaging and screen sharing capabilities in the browser.',
                keywords:
            ...
            og: {
                ...
                description: 'GupShup calling provides real-time video calls, messaging and screen sharing.',
                image: '',
                url: '',
            },
            html: {
